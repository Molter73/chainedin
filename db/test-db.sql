INSERT INTO jobs(title, description, company, creation_date) VALUES
...
The role is a fast-paced, problem-solving role that's challenging yet very exciting. The right candidate must be resourceful, articulate, and able to deliver on a wide variety of solutions across Server, PC and IoT technologies. Our teams partner with specialist engineers from major silicon companies to integrate next-generation features and performance enhancements for upcoming hardware.", 'Canonical', '2024-01-11'
...
En pleno proceso de crecimiento, la empresa está expandiendo su visibilidad tanto en España como en el resto de Europa. Actualmente, el proceso de prescripción de la propuesta de valor es clave de cara a que se puedan incluir en las licitaciones a lanzar, por esto necesitamos personas con experiencia en el sector que nos ayuden a aumentar nuestras oportunidades.", "Candam Tech", "2023-12-25"
...
D.med Software is a fast-growing company with focus on developing software systems for the medical industry with the vision to be the leading software service provider for the medical industry in cybersecurity for embedded software & cloud applications.", "D.med Healthcare Group", "2024-01-2");
